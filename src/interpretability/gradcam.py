...
@dataclass
class GradCAMResult:
    heatmap: np.ndarray          # float32, [H, W], 0..1
    overlay_rgb: np.ndarray      # uint8, [H, W, 3]
    image_rgb: np.ndarray        # uint8, [H, W, 3]
...
class GradCAM:
    ...
    def __call__(
        ...
        # Channel-wise global-average pooled gradients weight each activation map.
